...
const LiveReplaySwitch = () => {
  ...
  const fetchLiveData = async () => {
    try {
      // Fetch positions
      const posResponse = await fetch('http://https://f1-track-ai-production.up.railway.app/api/live/positions');
      ...
      if (!trackLayout) {
        const layoutResponse = await fetch('http://https://f1-track-ai-production.up.railway.app/api/live/track-layout');
