...
curl https://f1-track-ai-backend.onrender.com/api/sources/test | jq
...
curl https://f1-track-ai-backend.onrender.com/api/sources/status | jq '.status.sources'

# Get weather from best source
curl https://f1-track-ai-backend.onrender.com/api/live/weather | jq '.display'
```
...
cd backend
python main.py
# Server runs on https://f1-track-ai-backend.onrender.com
```
...
- **Race Prediction API:** https://f1-track-ai-backend.onrender.com/api/race/prediction
- **API Documentation:** https://f1-track-ai-backend.onrender.com/docs
...
### **Compare API Sources:**
```bash
curl https://f1-track-ai-backend.onrender.com/api/sources/test | jq '.timing.rankings'
```
...
- API: https://f1-track-ai-backend.onrender.com
- Prediction: https://f1-track-ai-backend.onrender.com/api/race/prediction
