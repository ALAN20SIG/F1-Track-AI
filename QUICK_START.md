...
```
✓ Backend:  https://f1-track-ai-backend.onrender.com  (FastAPI)
...
curl https://f1-track-ai-backend.onrender.com/api/live/positions

# Get Abu Dhabi circuit layout
curl https://f1-track-ai-backend.onrender.com/api/live/track-layout

# Get telemetry for specific driver (e.g., VER)
curl https://f1-track-ai-backend.onrender.com/api/live/telemetry/VER
```
...
4. Check model info: `curl https://f1-track-ai-backend.onrender.com/api/ml/model/info`
...
✅ **Backend Server**
- Running on https://f1-track-ai-backend.onrender.com
