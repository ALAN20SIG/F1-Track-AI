...
1. Switch to a different session manually:
   ```bash
   curl -X POST https://f1-track-ai-backend.onrender.com/api/session/switch?session_type=R&year=2025
   ```
...
2. Test endpoints manually:
   ...
   curl https://f1-track-ai-backend.onrender.com/api/analysis/race-telemetry
   ```
